...
--
-- Host: 127.0.0.1    Database: workshow_db
-- ------------------------------------------------------
...
INSERT INTO `clientes` VALUES (1,'Juan Pérez','juan.perez@email.com','123456','Calle Falsa 123','Ciudad de México','2025-08-28 03:56:20');
...
CREATE TABLE `documentos_trabajador` (
  ...
  `estado` enum('Verificado','Pendiente','Rechazado') DEFAULT 'Pendiente',
  `fecha_subida` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id_documento`),
  KEY `id_trabajador` (`id_trabajador`),
  CONSTRAINT `documentos_trabajador_ibfk_1` FOREIGN KEY (`id_trabajador`) REFERENCES `trabajadores` (`id_trabajador`) ON DELETE CASCADE
...
INSERT INTO `documentos_trabajador` VALUES (1,1,'Identificación Oficial.pdf','PDF','Verificado','2025-08-28 03:56:20'),(2,1,'Licencia de Conducir.jpg','Imagen','Pendiente','2025-08-28 03:56:20'),(3,1,'Certificado de Habilidad.zip','ZIP','Rechazado','2025-08-28 03:56:20');
...
INSERT INTO `trabajadores` VALUES (1,'Carlos Gómez','carlos.gomez@correo.com','abcdef','Electricista',5,'Especialista en instalaciones eléctricas residenciales y comerciales','Ciudad de México, Colonia Roma','2025-08-28 03:56:20');
...
INSERT INTO `usuarios` VALUES (1,'Juan Pérez','juan.perez@email.com','123456'),(2,'Mizushima','mizushimanaomiz@gmail.com','ladanivalegendbronto4x4');
...
-- Dump completed on 2025-09-05 13:22:18
-- MySQL dump 10.13  Distrib 8.0.43, for Win64 (x86_64)
--
...
CREATE TABLE `administradores` (
  ...
  `nivel_acceso` enum('superadmin','moderador') DEFAULT NULL,
...
INSERT INTO `administradores` VALUES (1,'superadmin');
...
CREATE TABLE `evaluaciones` (
  ...
  CONSTRAINT `evaluaciones_ibfk_1` FOREIGN KEY (`id_servicio`) REFERENCES `servicios` (`id_servicio`),
  CONSTRAINT `evaluaciones_chk_1` CHECK ((`puntuacion` between 1 and 5))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `roles_trabajadores`
--

DROP TABLE IF EXISTS `roles_trabajadores`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `roles_trabajadores`
--

LOCK TABLES `roles_trabajadores` WRITE;
/*!40000 ALTER TABLE `roles_trabajadores` DISABLE KEYS */;
INSERT INTO `roles_trabajadores` VALUES (1,'Pastelero');
/*!40000 ALTER TABLE `roles_trabajadores` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `servicios` (
  ...
  `estado` enum('pendiente','aceptado','completado','cancelado') DEFAULT NULL,
  PRIMARY KEY (`id_servicio`),
  KEY `id_cliente` (`id_cliente`),
  KEY `id_trabajador` (`id_trabajador`),
  CONSTRAINT `servicios_ibfk_1` FOREIGN KEY (`id_cliente`) REFERENCES `usuarios` (`id_usuario`),
  CONSTRAINT `servicios_ibfk_2` FOREIGN KEY (`id_trabajador`) REFERENCES `usuarios` (`id_usuario`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `servicios` VALUES (2,NULL,NULL,'Pastel de cumpleaños personalizado con tematica de Skirk de Genshin Impact','2025-08-01 15:26:49','2025-08-03 15:00:00','pendiente');
...
CREATE TABLE `solicitudes` (
  ...
  KEY `id_trabajador` (`id_trabajador`),
  KEY `id_servicio` (`id_servicio`),
  CONSTRAINT `solicitudes_ibfk_1` FOREIGN KEY (`id_cliente`) REFERENCES `usuarios` (`id_usuario`),
  CONSTRAINT `solicitudes_ibfk_2` FOREIGN KEY (`id_trabajador`) REFERENCES `usuarios` (`id_usuario`),
  CONSTRAINT `solicitudes_ibfk_3` FOREIGN KEY (`id_servicio`) REFERENCES `servicios` (`id_servicio`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2025-08-01 20:11:19',NULL),('diagnostics.include_raw','OFF','2025-08-01 20:11:19',NULL),('ps_thread_trx_info.max_length','65535','2025-08-01 20:11:19',NULL),('statement_performance_analyzer.limit','100','2025-08-01 20:11:19',NULL),('statement_performance_analyzer.view',NULL,'2025-08-01 20:11:19',NULL),('statement_truncate_len','64','2025-08-01 20:11:19',NULL);
...
CREATE TABLE `trabajadores` (
  ...
  KEY `id_rol` (`id_rol`),
  KEY `id_zona` (`id_zona`),
  CONSTRAINT `trabajadores_ibfk_1` FOREIGN KEY (`id_trabajador`) REFERENCES `usuarios` (`id_usuario`),
  CONSTRAINT `trabajadores_ibfk_2` FOREIGN KEY (`id_rol`) REFERENCES `roles_trabajadores` (`id_rol`),
  CONSTRAINT `trabajadores_ibfk_3` FOREIGN KEY (`id_zona`) REFERENCES `zonas` (`id_zona`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `usuarios` (
  ...
  `direccion` text,
  `rol` enum('cliente','trabajador','administrador','moderador','superadmin') DEFAULT NULL,
...
LOCK TABLES `usuarios` WRITE;
/*!40000 ALTER TABLE `usuarios` DISABLE KEYS */;
INSERT INTO `usuarios` VALUES (1,'Julian Camilo Lopez Sanchez','juliancamilolopezsanchez@gmail.com','niideadequeclaveperobueno',NULL,NULL,'superadmin',1,'2025-08-01 15:37:57');
/*!40000 ALTER TABLE `usuarios` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-09-05 13:22:21
